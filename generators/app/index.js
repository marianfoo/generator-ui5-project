    ...
    async addPackage() {
        ...
        let packge = {
            ...
            scripts: {
                ...
                lint: "eslint ./**/webapp/**/*.js && prettier --check ./**/webapp/**/*.{js,xml} --debug-check ",
                "lint-fix":
                    "eslint ./**/webapp/**/*.js --fix && prettier --write ./**/webapp/**/*.{js,xml} --debug-check  --no-error-on-unmatched-pattern"
            },
            devDependencies: {
                shx: "^0.3.3",
                "@ui5/cli": "^2.14.1",
